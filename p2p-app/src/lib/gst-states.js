// GST state/UT codes (the first two digits of every Indian GSTIN). Used to
// populate the Place of Supply dropdown and to auto-derive it from a vendor's
// GSTIN. Static reference data — not a DB table since it never changes.
const GST_STATES = [
...
const nameForCode = (code) => byCode[code] || null;

module.exports = { GST_STATES, nameForCode };
